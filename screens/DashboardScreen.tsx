...
export const DashboardScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={{ paddingTop: 16 }}>
        {/*Removed Text component as per the update request*/}
        ...
        <Card style={styles.chartCard}>
          ...
          <Text style={styles.chartSubtitle}>Pickups by shuttle this week</Text>
          <BarChart
            data={chartData}
